...
///////////////////////////////////////////////////////////////////////////////
   ...
   /////////////////////////////////////////////////////////////////////////
   {
      int  dimx = (N+K-1)/K;    //  ceil( ((float) N)/ K);
      int  dimy = (m+K-1)/K;    //  ceil( ((float) m)/ K);
      dim3 block(K, K, 1);
      dim3 grid (dimx, dimy, 1);
   ...
   /////////////////////////////////////////////////////////////////////////
   {
      ...
      ker7 <<< grid, block, 2*N*sizeof(float) >>> (m, N, d_yhat, d_Nss, d_yerrs, d_Y, d_indss);
      cudaDeviceSynchronize();
