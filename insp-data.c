                       ...
                       float hfrac_4577, float lam_4578)
{
    ...
    bool i_p_m_t_s_leq_w_4590 = slt32(24, m_4571);
    bool index_certs_4591;
    
    if (!i_p_m_t_s_leq_w_4590) {
        ctx->error = msgprintf("Error at %s:\n%s%d%s%d%s%d%s\n",
                               "insp-data.fut:3:1-15:61 -> insp-data.fut:13:7-18",
                               "Index [", 0, ":", 25,
    ...
    int64_t binop_x_4640 = 25 * binop_y_4639;
    ...
    if (memblock_alloc(ctx, &mem_4641, bytes_4637, "mem_4641"))
        return 1;
    for (int32_t i_4622 = 0; i_4622 < 25; i_4622++) {
